...
angular.module('myApp', ['ngRoute', 'jkAngularCarousel', 'ngMaterial', 'myApp.a', 'directive', 'slickCarousel'])

	.config(['$routeProvider', 'slickCarouselConfig', function ($routeProvider, slickCarouselConfig) {
		...
		$routeProvider.when('/home', {
			...
			.when('/open-account', {
				templateUrl: 'views/open-account.html',
				controller: 'pageController'
			})
			.when('/stock-price-matters-or-not', {
				templateUrl: 'views/stock-prices.html',
				controller: 'pageController'
			})
	...
	.controller('homeController', ['$scope', '$window', '$rootScope', '$route', '$location'
		, function ($scope, $window, $rootScope, $route, $location) {
			$rootScope.$on("$routeChangeSuccess",
				function (event, current, previous, rejection) {
					console.log($route.current.$$route.originalPath);
					$scope.fbComments = "http://dallalstreetinvestor.blogspot.in/2017/09" + $route.current.$$route.originalPath;
			...
			$scope.dataArray = [{
				src: 'images/learn/ipo.jpg',
				text: "All you need to know about an IPO",
				link: "#/getting-started-with-IPO"
			},
			{
				src: 'images/learn/richdad.jpg',
				text: "How to make money work for you?",
				link: "#/how-to-make-money-work-for-you"
			},
			{
				src: 'images/learn/moneycontrol.jpg',
				text: "How to use MoneyControl mobile app for Investing?",
				link: "#/using-moneycontrol-app"
			}
			];
			...
			$("#smoothscroll").animate({ scrollTop: 0 }, "slow");
			(function ($) {
